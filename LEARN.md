...
```bash
git remote add upstream https://github.com/original-owner-username/OpenTekHub/blockchain
```
...
2. **Clone the Repository:**
   ...
   - Choose the blockchain repository from the list of repositories on GitHub and clone it to your local machine.
...
7. **Create a Pull Request:**
  - Go to the GitHub website and navigate to your fork of the Blockchain repository.
